...
The Colleges academic honesty policies can be found in the catalog.
...
University of South Alabama is a community of scholars in which the
...
<https://www.southalabama.edu/coronavirus/>. Be advised that policies
may change during the semester, and students should check the
...
for rock samples and may also use [Rockd.org](https://rockd.org/) for
local outcrop locations if we are dispersed.
